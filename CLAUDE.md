# monicaHqClient Development Guidelines

Auto-generated from all feature plans. Last updated: 2025-10-26

## Active Technologies
- Swift 5.5+ with async/await suppor + SwiftUI, Core Data, Foundation (zero external dependencies) (001-004-call-logging)
- Core Data with SQLite backend, programmatic model creation (001-004-call-logging)
...
- 001-004-call-logging: Added Swift 5.5+ with async/await suppor + SwiftUI, Core Data, Foundation (zero external dependencies)
